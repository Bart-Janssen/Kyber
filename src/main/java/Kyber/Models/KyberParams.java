...
public class KyberParams
{
    ...
    public final static short paramsIndcpaSecretKeyBytesK1024 = 4 * paramsPolyBytes;
    public final static short paramsIndcpaSecretKeyBytesK768 = 3 * paramsPolyBytes;
    public final static short paramsPolyvecBytesK1024 = 4 * paramsPolyBytes;
    public final static short paramsPolyvecBytesK512 = 2 * paramsPolyBytes;
    public final static short paramsPolyvecBytesK768 = 3 * paramsPolyBytes;
    public final static short paramsIndcpaPublicKeyBytesK768 = paramsPolyvecBytesK768 + paramsSymBytes;
    public final static short paramsIndcpaPublicKeyBytesK1024 = paramsPolyvecBytesK1024 + paramsSymBytes;
    public final static short Kyber512SKBytes = paramsPolyvecBytesK512 + ((paramsPolyvecBytesK512 + paramsSymBytes) + 2 * paramsSymBytes);
    public final static short Kyber768SKBytes = paramsPolyvecBytesK768 + ((paramsPolyvecBytesK768 + paramsSymBytes) + 2 * paramsSymBytes);
    public final static short Kyber1024SKBytes = paramsPolyvecBytesK1024 + ((paramsPolyvecBytesK1024 + paramsSymBytes) + 2 * paramsSymBytes);
